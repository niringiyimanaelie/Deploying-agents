...
$$
name: PLATFORM_HEALTH_ANALYST_SM
  ...
  - name: QUERY_INSIGHTS
    ...
    filters:
      - name: FilterEfficiencyInsights
        ...
        expr: MESSAGE::TEXT ILIKE '%WHERE clause%' OR MESSAGE::TEXT ILIKE '%filter%' OR MESSAGE::TEXT ILIKE '%selectivity%'
      - name: HighImpactInsights
        ...
        expr: MESSAGE::TEXT ILIKE '%large amount of data%' OR MESSAGE::TEXT ILIKE '%significantly reduce%' OR MESSAGE::TEXT ILIKE '%no effect%'
    ...
    metrics:
      ...
      - name: CriticalInsightPercentage
        ...
        expr: (COUNT(CASE WHEN MESSAGE::TEXT ILIKE '%large amount of data%' OR MESSAGE::TEXT ILIKE '%no effect%' THEN 1 END) * 100.0) / COUNT(*)
  ...
  - name: VIEWS
    ...
    filters:
      ...
      - name: ComplexViews
        ...
        expr: TO_VARCHAR(VIEW_DEFINITION) ILIKE '%JOIN%' OR TO_VARCHAR(VIEW_DEFINITION) ILIKE '%UNION%' OR TO_VARCHAR(VIEW_DEFINITION) ILIKE '%SUBQUERY%' OR LENGTH(TO_VARCHAR(VIEW_DEFINITION)) > 1000
    ...
    metrics:
      ...
      - name: ComplexViewPercentage
        ...
        expr: (COUNT(CASE WHEN TO_VARCHAR(VIEW_DEFINITION) ILIKE '%JOIN%' OR TO_VARCHAR(VIEW_DEFINITION) ILIKE '%UNION%' OR LENGTH(TO_VARCHAR(VIEW_DEFINITION)) > 1000 THEN 1 END) * 100.0) / COUNT(*)
  ...
  - name: TAGS
    ...
    filters:
      ...
      - name: ComplianceTags
        ...
        expr: TAG_NAME ILIKE '%COMPLIANCE%' OR TAG_NAME ILIKE '%GDPR%' OR TAG_NAME ILIKE '%HIPAA%' OR TAG_NAME ILIKE '%SOX%' OR TAG_NAME ILIKE '%AUDIT%'
      - name: EnumeratedTags
        synonyms:
          - allowed value tags
          - enumerated tags
      ...
      - name: SecurityClassificationTags
        ...
        expr: TAG_NAME ILIKE '%SECURITY%' OR TAG_NAME ILIKE '%CLASSIFICATION%' OR TAG_NAME ILIKE '%CONFIDENTIAL%' OR TAG_NAME ILIKE '%SENSITIVE%'
    metrics:
      ...
      - name: ComplianceTagPercentage
        ...
        expr: (COUNT(CASE WHEN TAG_NAME ILIKE '%COMPLIANCE%' OR TAG_NAME ILIKE '%GDPR%' OR TAG_NAME ILIKE '%HIPAA%' OR TAG_NAME ILIKE '%SOX%' THEN 1 END) * 100.0) / COUNT(*)
      ...
      - name: SecurityTagPercentage
        ...
        expr: (COUNT(CASE WHEN TAG_NAME ILIKE '%SECURITY%' OR TAG_NAME ILIKE '%CLASSIFICATION%' OR TAG_NAME ILIKE '%CONFIDENTIAL%' THEN 1 END) * 100.0) / COUNT(*)
      - name: TotalTagCount
        synonyms:
          - number of tags
          - tag count
  ...
  - name: ROW_ACCESS_POLICIES
    ...
    filters:
      ...
      - name: ConditionalPolicies
        ...
        expr: POLICY_BODY ILIKE '%AND%' OR POLICY_BODY ILIKE '%OR%' OR POLICY_BODY ILIKE '%CASE%' OR POLICY_BODY ILIKE '%WHEN%'
      ...
      - name: RoleBasedPolicies
        ...
        expr: POLICY_BODY ILIKE '%CURRENT_ROLE%' OR POLICY_BODY ILIKE '%IS_ROLE_IN_SESSION%' OR POLICY_BODY ILIKE '%ROLE%'
      - name: UserBasedPolicies
        ...
        expr: POLICY_BODY ILIKE '%CURRENT_USER%' OR POLICY_BODY ILIKE '%USER%' OR POLICY_BODY ILIKE '%SESSION%'
    metrics:
      ...
      - name: ConditionalPolicyPercentage
        ...
        expr: (COUNT(CASE WHEN POLICY_BODY ILIKE '%AND%' OR POLICY_BODY ILIKE '%OR%' OR POLICY_BODY ILIKE '%CASE%' THEN 1 END) * 100.0) / COUNT(*)
      ...
      - name: RoleBasedPolicyPercentage
        ...
        expr: (COUNT(CASE WHEN POLICY_BODY ILIKE '%CURRENT_ROLE%' OR POLICY_BODY ILIKE '%IS_ROLE_IN_SESSION%' THEN 1 END) * 100.0) / COUNT(*)
      ...
      - name: UserBasedPolicyPercentage
        ...
        expr: (COUNT(CASE WHEN POLICY_BODY ILIKE '%CURRENT_USER%' OR POLICY_BODY ILIKE '%USER%' THEN 1 END) * 100.0) / COUNT(*)
    primary_key:
      columns:
        - POLICY_ID
  - name: DATABASES
    ...
    filters:
      ...
      - name: DevelopmentDatabases
        ...
        expr: DATABASE_NAME ILIKE '%DEV%' OR DATABASE_NAME ILIKE '%TEST%' OR DATABASE_NAME ILIKE '%SANDBOX%' OR DATABASE_NAME ILIKE '%STAGING%'
      ...
      - name: ProductionDatabases
        ...
        expr: DATABASE_NAME ILIKE '%PROD%' OR DATABASE_NAME ILIKE '%PRODUCTION%' OR DATABASE_NAME ILIKE '%LIVE%'
    ...
    metrics:
      ...
      - name: ProductionDatabasePercentage
        ...
        expr: (COUNT(CASE WHEN DATABASE_NAME ILIKE '%PROD%' OR DATABASE_NAME ILIKE '%PRODUCTION%' THEN 1 END) * 100.0) / COUNT(*)
    ...
    sql: |-
      WITH active_policies AS (
        SELECT
          ...
          COUNT(
            CASE
              WHEN rap.policy_body ILIKE '%CURRENT_ROLE%' THEN 1
            END
          ) AS role_based_policies,
          COUNT(
            CASE
              WHEN rap.policy_body ILIKE '%CURRENT_USER%' THEN 1
            END
          ) AS user_based_policies,
          COUNT(
            CASE
              WHEN rap.policy_body ILIKE '%CASE%'
              OR rap.policy_body ILIKE '%WHEN%' THEN 1
            END
      ...
      tag_coverage AS (
        SELECT
          ...
          COUNT(
            CASE
              WHEN t.tag_name ILIKE '%SECURITY%'
              OR t.tag_name ILIKE '%CLASSIFICATION%' THEN 1
            END
          ) AS security_tags,
          COUNT(
            CASE
